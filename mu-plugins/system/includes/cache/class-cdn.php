...
final class CDN {
	...
	/**
	 * File formats to be cached.
	 *
	 * @link  https://codex.wordpress.org/Uploading_Files#About_Uploading_Files_on_Dashboard
	 * @since 1.0.0
	 *
	 * @var array
	 */
	const FILE_FORMATS = [ 'gif', 'ico', 'jpeg', 'jpg', 'png' ];
