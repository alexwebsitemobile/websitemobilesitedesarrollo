...
final class Control {
	...
	public static function purge( array $urls ) {
		...
		/**
		 * Fires after specific URLs have been purged from cache.
		 *
		 * @since 1.0.0
		 *
		 * @param array $results Array of URLs purged from cache.
		 */
		do_action( 'mwp_system_cache_purge', $urls );
